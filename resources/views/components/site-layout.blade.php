...
<head>
    ...
    <title inertia>{{ $seo->get('website_name') }}</title>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="/site/images/icons/apple-touch-icon.png">
    ...
    <link rel="stylesheet" href="{{asset('/site/css/plugins/owl-carousel/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('/site/css/plugins/magnific-popup/magnific-popup.css')}}">
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{asset('/site/css/style.css')}}">
    @routes
    @vite(['Modules/Site/resources/js/app.js'])
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="{{route('index')}}" class="logo">
                            <img src="{{ asset('storage/'. $settings->get('white_logo'))   }}" alt="Molla Logo" width="105" height="25">
                        </a>
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="/site/images/logo-footer.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		...
	        		<figure class="footer-payments">
	        			<img src="/site/images/payments.png" alt="Payment methods" width="272" height="20">
